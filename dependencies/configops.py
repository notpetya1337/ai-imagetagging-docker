...
class MainConfig:
    def __init__(self, configpath):
        ...
        self.maxlength = self.config.getint("properties", "maxlength")
        self.sleeptime = self.config.getint("properties", "sleeptime")
        self.connectstring = self.config.get("storage", "connectionstring")
        self.redishost = self.config.get("storage", "redishost")
        self.redisport = self.config.getint("storage", "redisport")
        ...
        self.mongoscreenshotcollection = self.config.get("storage", "mongoscreenshotcollection")
        ...
        self.google_credentials = self.config.get("image-recognition", "google-credentials")
        ...
        self.process_only_new = self.config.getboolean("flags", "process_only_new")
        ...
        self.process_screenshots = self.config.getboolean("flags", "process_screenshots")
        self.write_exif = self.config.getboolean("flags", "write_exif")
